...
class EnvironmentalReadings:
    ...
    def show_data(self, scroll_speed: float = 2.0, pointer: int = -1):
    ...
    def show_actual_data(self, code: int = 7, scroll_speed: float = 2):
...
if __name__ == "__main__":
    ...
    sensor.show_actual_data(code=7, scroll_speed=0.1)
